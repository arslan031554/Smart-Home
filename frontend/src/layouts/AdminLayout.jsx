        ...
        <div className="min-h-screen bg-gradient-surface text-textPrimary">
            ...
            <div className="flex min-h-screen">
                ...
                <aside className={clsx(
                    'dark-surface fixed inset-y-0 left-0 z-50 w-[19rem] border-r border-white/10 backdrop-blur-2xl transition-transform duration-300 md:relative md:translate-x-0',
                                    ...
                                    <section key={section.key} className="space-y-3">
                                        {section.title ? (
                                            <div className="flex items-center gap-3 px-2">
                                                ...
                                                <div className="h-px flex-1 bg-gradient-to-r from-primary-500/20 via-white/8 to-transparent" />
                                            </div>
                                        ) : null}

                                        <div className="rounded-[1.55rem] border border-white/6 bg-white/[0.03] p-2.5">
                                                ...
                                                {section.items.map((item) => {
                                                    ...
                                                    return (
                                                        <Link
                                                            ...
                                                            onClick={() => setIsSidebarOpen(false)}
                                                            className={clsx(
                                                                'group/item relative flex items-center gap-3 overflow-hidden rounded-[1.2rem] border px-3.5 py-3 transition-all duration-300',
                                                                isActive
                        ...
                        <div className="mt-6 rounded-[1.7rem] border border-white/8 bg-white/[0.04] p-4">
                            <div className="flex items-center gap-3">
                                ...
                                <button
                                    ...
                                    className="rounded-full border border-white/8 p-2 text-textSecondary transition-colors hover:border-red-500/20 hover:bg-red-500/10 hover:text-red-300"
                                >
                        ...
                        <div className="flex items-center justify-between gap-4">
                            <div className="flex min-w-0 items-center gap-3">
                                ...
                                <div className="lg:hidden">
                                    <p className="text-[10px] font-semibold uppercase tracking-[0.24em] text-primary-300">Backoffice</p>
                                        ...
                                        <>
                                            ...
                                            <div className="premium-panel absolute right-0 z-20 mt-3 w-64 overflow-hidden rounded-[1.5rem] border border-white/10">
                                                <div className="border-b border-white/8 px-5 py-4">
                                                    <p className="text-[10px] font-semibold uppercase tracking-[0.22em] text-primary-300">Account</p>
