...
const featureIcons = [
  [/(light|scene|ambience|iluminat|scenari|lumin|ambian)/i, Lightbulb],
  [/(climate|temperature|heating|cooling|thermal|climat|temperatur|încălz|incalz|răcir|racir|termic)/i, ThermometerSun],
  [/(security|safe|alarm|intrusion|protection|securit|alarm|efrac|protec|siguran)/i, ShieldCheck],
  [/(access|credential|permission|entry|door|acces|creden|permisiun|intrar|uș|usi)/i, KeyRound],
  [/(energy|load|electric|solar|storage|battery|energi|sarcin|panou|bater|stocar)/i, BatteryCharging],
  [/(water|irrigation|soil|leak|apă|apa|iriga|sol|scurger|udare)/i, Droplets],
  [/(air|ventilation|fresh|humidity|aer|ventila|proaspăt|proaspat|umidit)/i, AirVent],
  [/(audio|music|speaker|volume|sound|muzic|box|volum|sunet)/i, AudioLines],
  [/(camera|cctv|video|surveillance|supravegh)/i, Camera],
  [/(app|mobile|remote|control|aplica|mobil|distan|comenz)/i, Smartphone],
  [/(schedule|time|routine|program|orar|rutin|timp)/i, CalendarClock],
  [/(meter|report|monitor|data|consumption|audit|contor|raport|consum)/i, ChartNoAxesCombined],
  [/(shade|blind|shutter|curtain|sun|umbr|jaluze|perdel|draperi|rulou|solar)/i, PanelsTopLeft],
  [/(presence|occupancy|people|guest|staff|user|prezen|ocupar|oaspe|utilizator)/i, Users],
  [/(cinema|movie|projector|film|proiec)/i, Film],
  [/(zone|group|multi|zon|grup)/i, Building2],
  [/(voice|notification|communication|voce|notific)/i, Radio],
  [/(weather|daylight|vreme|prognoz)/i, CloudSun],
  [/(efficiency|saving|cost|billing|eficien|economi|factur|buget)/i, Gauge],
  [/(integration|system|automation|central|integr|sistem|automatiz|centraliz)/i, Settings2],
];
